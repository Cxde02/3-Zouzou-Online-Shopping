...
<head>
    ...
    <title>Product Details | 3Zouzou</title>
...
<body class="prodd">
    <?php include("navbarproductdetail.php") ?>
...
<div class="small-container single-product">
    <div class="rowpd">
        ...
        <div class="col-2prodd2">
            <h1><?php echo $row["product_title"]; ?></h1>
            <h4 style="color: red; font-family: 'courier new',serif"><?php echo "Rs " . $row["product_price"]; ?></h4>
